...
const lister = () => {
    if(listeFilms == null){
        document.getElementsByClassName('container')[0].innerHTML = "<strong>Vous devez préalablement charger le fichier de données<br>films.json. Merci de votre collaboration.</strong>";
    }else{
