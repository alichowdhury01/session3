...
let formAuteur = () => {
    ...
    <form class="row g-3 needs-validation" novalidate>
        <div class="col-md-6">
            <label for="annee" class="form-label">Code auteur</label>
...
let formComprisAnnees = () => {
    let rep = `
    <form class="row g-3 needs-validation" novalidate>
        <div class="col-md-6">
            <label for="annee" class="form-label">Année du début</label>
            <input type="text" class="form-control" id="and" name="and" value="" required>
        </div>
        <div class="col-md-6">
            <label for="annee" class="form-label">Année de la fin</label>
            <input type="text" class="form-control" id="anf" name="anf" value="" required>
        </div>
        <div class="col-12">
            <button class="btn btn-primary" type="button" onClick="listerEntreDeuxAnnees();">Envoyer</button>
        </div>
    </form>
`;
 document.getElementsByClassName('container')[0].innerHTML = rep;
